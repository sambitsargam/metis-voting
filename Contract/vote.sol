...
contract Voting {
    ...
    uint polls_created;
    // Mapping of addresses to the usernames
    ...
    function createPoll(string memory name, string memory description, uint start_time, uint end_time, uint fee, string[] memory options) public {
        ...
        // Check the end time after start time
        require(end_time >= start_time);
        // Check the more than one option
        ...
        // Increment poll id it increase from 0,1,2....
        polls_created++;
    }
